#
#  Be sure to run `pod spec lint mim-OE-ai-SE-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "5.10.0"
  s.summary      = "SDK for embedding mim OE runtime (Full license, with AI support)"
...
- Developer Console integration: prebuilt authentication views, application APIs, and ID token handling
  ...
  s.source       = { :git => "https://github.com/mimikgit/cocoapod-mim-OE-ai-SE-iOS", :tag => "#{s.version}" }
