#
#  Be sure to run `pod spec lint mim-OE-ai-SE-iOS-developer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "5.10.0"
  s.summary      = "SDK for embedding mim OE runtime (Developer license, with AI support)"
...
- Developer Console integration: prebuilt authentication views, application APIs, and ID token handling
  ...
  s.homepage     = "https://github.com/mimikgit/cocoapod-mim-OE-ai-SE-iOS-developer"
  s.license      = { :type => "CUSTOM", :file => "LICENSE" }

  s.author       = { "mimik" => "apps@mimik.com" }
  s.source       = { :git => "https://github.com/mimikgit/cocoapod-mim-OE-ai-SE-iOS-developer", :tag => "#{s.version}" }
