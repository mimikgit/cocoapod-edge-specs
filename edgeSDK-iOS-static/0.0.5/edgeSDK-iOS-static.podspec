...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/mimikgit/cocoapod-edge-static.git", :tag => "#{s.version}" }

  s.vendored_frameworks = "edgesdk_ios_framework_dynamic.framework", "edge.framework"
# s.vendored_libraries = "edge.framework"
