#
#  Be sure to run `pod spec lint mimOE-SE-iOS.podspec' to ensure this is a
...
The mimik iOS suite consists of three individual cocoapod components:
  ...
  s.homepage     = "https://github.com/mimikgit/cocoapod-mimOE-SE-iOS"
  s.license      = { :type => "CUSTOM", :file => "LICENSE" }

  s.author       = { "mimik" => "apps@mimik.com" }
  s.source       = { :git => "https://github.com/mimikgit/cocoapod-mimOE-SE-iOS.git", :tag => "#{s.version}" }
