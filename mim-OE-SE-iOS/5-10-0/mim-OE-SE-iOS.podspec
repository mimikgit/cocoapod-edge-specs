#
#  Be sure to run `pod spec lint mim-OE-SE-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "mim-OE-SE-iOS"
  s.version      = "5.10.0"
  s.summary      = "SDK for embedding mim OE runtime (Full license, no AI support)"
...
- Developer Console integration: prebuilt authentication views, application APIs, and ID token handling
  ...
  s.homepage     = "https://github.com/mimikgit/cocoapod-mim-OE-SE-iOS"
  s.license      = { :type => "CUSTOM", :file => "LICENSE" }

  s.author       = { "mimik" => "apps@mimik.com" }
  s.source       = { :git => "https://github.com/mimikgit/cocoapod-mim-OE-SE-iOS", :tag => "#{s.version}" }
